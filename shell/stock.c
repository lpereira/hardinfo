...
static struct
{
 ...
 gchar *stock_id;
    ...
    {SVG_ABOUT, HI_STOCK_ABOUT},
    {SVG_REFRESH, HI_STOCK_REFRESH},
    {SVG_REPORT, HI_STOCK_REPORT},
    {SVG_INTERNET, HI_STOCK_INTERNET},
    {SVG_SYNC, HI_STOCK_SYNC},
    {SVG_QUIT, HI_STOCK_QUIT}};
