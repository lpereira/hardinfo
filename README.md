...
As we use GPL2.1 and GPL3 code and would like to future proof the project. Therefor lpereira has agreed to change license of source code also to GPL2+. (https://github.com/lpereira/hardinfo/issues/530).
